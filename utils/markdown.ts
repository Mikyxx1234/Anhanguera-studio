 ...
 *  - URLs com espaço em imagens/links              -> espaços viram %20
...
/**
 * Normaliza, renderiza e sanitiza markdown para HTML seguro.
 * Usado em dangerouslySetInnerHTML no site público.
 */
 ...
 * Estilos explícitos para h1..h4, p, strong, ul, ol, li, a,
 * blockquote, code, pre, hr e img. Independe do plugin
 * @tailwindcss/typography (que não está instalado).
 */
 ...
 * Injetado via JS quando um <img> dispara onerror.
 */
